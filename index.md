...
value—including the result of
[`eligibility_rate()`](https://docs.ropensci.org/outcomerate/reference/eligibility_rate.md)—keeps
the original behavior and applies to every unknown category.
